...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_4bb9041706a7d1c4, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4bb9041706a7d1c4, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "simplechain.simplechain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "simplechain.simplechain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("simplechain/simplechain/tx.proto", fileDescriptor_4bb9041706a7d1c4) }

var fileDescriptor_4bb9041706a7d1c4 = []byte{
	// 340 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x28, 0xce, 0xcc, 0x2d,
	0xc8, 0x49, 0x4d, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x66, 0x97, 0x54, 0xe8, 0x15, 0x14, 0xe5,
	...
	0x55, 0x09, 0xb3, 0x52, 0x8a, 0xb5, 0x01, 0xe4, 0x35, 0x27, 0xef, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	...
	0xd5, 0x4f, 0x2c, 0xcb, 0x4f, 0xca, 0x81, 0x7a, 0x4e, 0x17, 0x9b, 0x5f, 0x4b, 0x2a, 0x0b, 0x52,
	0x8b, 0x93, 0xd8, 0xc0, 0xd1, 0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xa7, 0xb7, 0x40, 0x20,
	0x76, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/simplechain.simplechain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simplechain.simplechain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "simplechain.simplechain.Msg",
	...
	Metadata: "simplechain/simplechain/tx.proto",
}
